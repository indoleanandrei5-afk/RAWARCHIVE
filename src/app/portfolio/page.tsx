...
export const metadata: Metadata = {
  title: "Portfolio",
  description:
    "Browse hand-edited portraits, architecture, travel, and editorial photography with clean, natural finishing.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Hand-edited portraits, architecture, travel, and editorial work with natural finishing.",
    url: "/portfolio",
    type: "website",
