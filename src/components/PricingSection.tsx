  ...
  return (
    <section className="bg-[#050505] px-5 py-20 text-white sm:px-6 sm:py-24">
      <div className="mx-auto max-w-6xl">
        ...
        >
          <p className="inline-flex rounded-full border border-white/15 bg-white/6 px-4 py-2 text-xs uppercase tracking-[0.28em] text-gray-300 sm:text-sm sm:tracking-[0.4em]">Pricing</p>
        ...
        >
          <motion.div
            ...
            className="rounded-4xl border border-white/15 bg-black/40 p-10 text-left transition hover:border-white/25 hover:bg-white/8"
          >
          ...
          <motion.div
            variants={{ hidden: { opacity: 0, y: 20 }, show: { opacity: 1, y: 0 } }}
            transition={{ duration: 0.55, ease: "easeOut" }}
            className="rounded-4xl border border-white/15 bg-white/8 p-10 text-left shadow-[0_30px_80px_-60px_rgba(197,210,227,0.5)] transition hover:border-white/25 hover:bg-white/12"
          >
        ...
        <div className="mx-auto mt-12 w-full max-w-2xl rounded-[28px] border border-white/15 bg-black/35 p-3 shadow-[0_28px_90px_-60px_rgba(197,210,227,0.65)] backdrop-blur-xl sm:p-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <Link
              href="/upload"
              className="inline-flex w-full justify-center rounded-full border border-white/20 bg-(--accent-strong) px-7 py-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#0b111a] transition hover:bg-(--accent) sm:w-auto"
            >
              Upload Photos
            </Link>
            <Link
